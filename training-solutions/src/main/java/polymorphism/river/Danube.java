...
public class Danube extends River {
    ...
    public static void main(String[] args) {
        Water water = new Danube("Duna", 2850, List.of("Bécs", "Pozsony", "Budapest", "Belgrád"));

        River river = new Danube("Duna", 2850, List.of("Bécs", "Pozsony", "Budapest", "Belgrád"));
        System.out.println(river.getName());
        System.out.println(river.getLength());

        Danube danube = new Danube("Duna", 2850, List.of("Bécs", "Pozsony", "Budapest", "Belgrád"));
