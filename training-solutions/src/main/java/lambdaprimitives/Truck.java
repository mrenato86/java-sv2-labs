...
public class Truck {
    ...
    private final List<Cargo> thingsToLoad;
    ...
    public String getWeightStatistics() {
        ...
        if (stats.getCount() > 0) {
            return String.format(
                    "A rakományban található %d tétel, melyeknek összsúlya %d kg, közülük a " +
                            "legnehezebb %d kg, a legkönnyebb %d kg. A súlyuk átlagosan %.1f kg.",
