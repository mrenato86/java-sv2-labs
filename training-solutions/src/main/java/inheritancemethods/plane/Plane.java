...
public class Plane {
    ...
    public static void main(String[] args) {
        Passenger passenger = new Passenger("John Doe", 45000);
        System.out.println(passenger.getName());
        System.out.println(passenger.getPriceOfPlaneTicket());

        PriorityPassenger priorityPassenger = new PriorityPassenger("Better Doe", 45000, 30);
        ...
        FirstClassPassenger firstClassPassenger = new FirstClassPassenger("Rich Doe", 45000, 30);
